...
RUN /root/mambaforge/bin/mamba install cudatoolkit==11.3 python rapids pytorch torchvision torchaudio pyg jupyter pandas -y -n base -c rapidsai -c nvidia -c pytorch -c pyg -c conda-forge
