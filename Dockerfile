...
RUN /root/mambaforge/bin/mamba install cudatoolkit==11.3.1 python rapids==22.10 pytorch torchvision torchaudio pyg jupyter pandas -y -n base -c rapidsai -c nvidia -c pytorch -c pyg -c conda-forge
